...
namespace CompleteWeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/weather?lat={latitude}&lon={longitude}&appid=738111c52e27c16836829ba53fd2d889&units=metric";
        ...
        private async void GetForecast()
        {
            ...
            if (result.Successful)
            {
                try
                {
                    ...
                    if (forcastInfo != null && forcastInfo.list != null)
                    {
